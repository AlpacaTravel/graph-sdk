...
for use with URQL and React.

- See [Installation and Getting Started](https://alpacatravel.github.io/graph-sdk/packages/react-urql/)
  `;
  const footer = ``;
...
function info(input) {
  ...
  const link = `https://alpacatravel.github.io/graph-sdk/packages/urql/docs/modules.html#${title}`;
