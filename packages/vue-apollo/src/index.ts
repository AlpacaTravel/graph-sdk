...
export type CollectionAttrsArgs = {
  ...
  first: Scalars['Int'];
  id?: Maybe<Scalars['ID']>;
  includeNoLocale?: Maybe<Scalars['Boolean']>;
  locale?: Maybe<Scalars['String']>;
};
...
export type CreateItineraryInput = {
  ...
  icons?: Maybe<Array<CreateIconCompositionInput>>;
...
export type CreateProfileInput = {
  ...
  /** The avatar image */
  avatar?: Maybe<MediaContainerInput>;
  /** A short biography */
...
export type ItineraryChildrenArgs = {
  ...
  segmentIds?: Maybe<Array<Scalars['ID']>>;
...
export type MutationCaptureMarketingInformationArgs = {
  intendedUses?: Maybe<Scalars['String']>;
...
export type UpdateConnectedAppInput = {
  ...
  authType?: Maybe<ConnectedAppAuthType>;
  /** Encrypted JSON */
  privateConfiguration?: Maybe<Scalars['String']>;
  /** 3rd party ID or account ID */
  publicId?: Maybe<Scalars['ID']>;
  /** Any specific scope that has been granted to the 3rd party application */
  scope?: Maybe<Scalars['String']>;
...
export type UpdateItineraryInput = {
  ...
  autoRouteRemoveExisting?: Maybe<Scalars['Boolean']>;
  /** Add new IconCompositions to the itinerary */
  createIcons?: Maybe<Array<CreateIconCompositionInput>>;
  /** Add multiple Media with MediaResources */
  createMedia?: Maybe<Array<CreateMediaContainerInput>>;
  /** The default locale of this itinerary's content */
  defaultLocale?: Maybe<Scalars['String']>;
  ...
  deleteIcons?: Maybe<Array<Scalars['ID']>>;
  /** Delete one or move MediaContainers */
  deleteMedia?: Maybe<Array<Scalars['ID']>>;
  ...
  updateIcons?: Maybe<Array<UpdateIconCompositionInput>>;
  /** Update one or move MediaContainers */
  updateMedia?: Maybe<Array<UpdateMediaContainerInput>>;
  /** Insert or update attributes to the collection */
  upsertAttrs?: Maybe<Array<AttributeInput>>;
 ...
 *
 * To run a mutation, you first call `useDeleteCollectionLocationMutation` within a Vue component and pass it any options that fit your needs.
 * When your component renders, `useDeleteCollectionLocationMutation` returns an object that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - Several other properties: https://v4.apollo.vuejs.org/api/use-mutation.html#return
 *
 * @param options that will be passed into the mutation, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/mutation.html#options;
 *
 * @example
 * const { mutate, loading, error, onDone } = useDeleteCollectionLocationMutation({
 *   variables: {
 *     id: // value for 'id'
 *   },
 * });
 */
export function useDeleteCollectionLocationMutation(options: VueApolloComposable.UseMutationOptions<DeleteCollectionLocationMutation, DeleteCollectionLocationMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<DeleteCollectionLocationMutation, DeleteCollectionLocationMutationVariables>>) {
  return VueApolloComposable.useMutation<DeleteCollectionLocationMutation, DeleteCollectionLocationMutationVariables>(DeleteCollectionLocationDocument, options);
}
export type DeleteCollectionLocationMutationCompositionFunctionResult = VueApolloComposable.UseMutationReturn<DeleteCollectionLocationMutation, DeleteCollectionLocationMutationVariables>;
 ...
 *
 * To run a mutation, you first call `useCreateItineraryLocationMutation` within a Vue component and pass it any options that fit your needs.
 * When your component renders, `useCreateItineraryLocationMutation` returns an object that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - Several other properties: https://v4.apollo.vuejs.org/api/use-mutation.html#return
 *
 * @param options that will be passed into the mutation, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/mutation.html#options;
 *
 * @example
 * const { mutate, loading, error, onDone } = useCreateItineraryLocationMutation({
 *   variables: {
 *     itineraryId: // value for 'itineraryId'
 *     location: // value for 'location'
 *   },
 * });
 */
export function useCreateItineraryLocationMutation(options: VueApolloComposable.UseMutationOptions<CreateItineraryLocationMutation, CreateItineraryLocationMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<CreateItineraryLocationMutation, CreateItineraryLocationMutationVariables>>) {
  return VueApolloComposable.useMutation<CreateItineraryLocationMutation, CreateItineraryLocationMutationVariables>(CreateItineraryLocationDocument, options);
}
export type CreateItineraryLocationMutationCompositionFunctionResult = VueApolloComposable.UseMutationReturn<CreateItineraryLocationMutation, CreateItineraryLocationMutationVariables>;
 ...
 *
 * To run a mutation, you first call `useCreateItineraryMutation` within a Vue component and pass it any options that fit your needs.
 * When your component renders, `useCreateItineraryMutation` returns an object that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - Several other properties: https://v4.apollo.vuejs.org/api/use-mutation.html#return
 *
 * @param options that will be passed into the mutation, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/mutation.html#options;
 *
 * @example
 * const { mutate, loading, error, onDone } = useCreateItineraryMutation({
 *   variables: {
 ...
 * });
 */
export function useCreateItineraryMutation(options: VueApolloComposable.UseMutationOptions<CreateItineraryMutation, CreateItineraryMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<CreateItineraryMutation, CreateItineraryMutationVariables>>) {
  return VueApolloComposable.useMutation<CreateItineraryMutation, CreateItineraryMutationVariables>(CreateItineraryDocument, options);
}
 ...
 *
 * To run a mutation, you first call `useDeleteItineraryLocationMutation` within a Vue component and pass it any options that fit your needs.
 * When your component renders, `useDeleteItineraryLocationMutation` returns an object that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - Several other properties: https://v4.apollo.vuejs.org/api/use-mutation.html#return
 *
 * @param options that will be passed into the mutation, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/mutation.html#options;
 ...
 * });
 */
export function useDeleteItineraryLocationMutation(options: VueApolloComposable.UseMutationOptions<DeleteItineraryLocationMutation, DeleteItineraryLocationMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<DeleteItineraryLocationMutation, DeleteItineraryLocationMutationVariables>>) {
 ...
 *
 * To run a mutation, you first call `useDisableItineraryAutoRouteMutation` within a Vue component and pass it any options that fit your needs.
 * When your component renders, `useDisableItineraryAutoRouteMutation` returns an object that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - Several other properties: https://v4.apollo.vuejs.org/api/use-mutation.html#return
 *
 * @param options that will be passed into the mutation, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/mutation.html#options;
 *
 * @example
 * const { mutate, loading, error, onDone } = useDisableItineraryAutoRouteMutation({
 *   variables: {
 *     id: // value for 'id'
 *   },
 * });
 */
export function useDisableItineraryAutoRouteMutation(options: VueApolloComposable.UseMutationOptions<DisableItineraryAutoRouteMutation, DisableItineraryAutoRouteMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<DisableItineraryAutoRouteMutation, DisableItineraryAutoRouteMutationVariables>>) {
  return VueApolloComposable.useMutation<DisableItineraryAutoRouteMutation, DisableItineraryAutoRouteMutationVariables>(DisableItineraryAutoRouteDocument, options);
}
 ...
 *
 * To run a mutation, you first call `useEnableItineraryAutoRouteMutation` within a Vue component and pass it any options that fit your needs.
 * When your component renders, `useEnableItineraryAutoRouteMutation` returns an object that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - Several other properties: https://v4.apollo.vuejs.org/api/use-mutation.html#return
 *
 * @param options that will be passed into the mutation, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/mutation.html#options;
 *
 * @example
 * const { mutate, loading, error, onDone } = useEnableItineraryAutoRouteMutation({
 *   variables: {
 *     id: // value for 'id'
 ...
 * });
 */
export function useEnableItineraryAutoRouteMutation(options: VueApolloComposable.UseMutationOptions<EnableItineraryAutoRouteMutation, EnableItineraryAutoRouteMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<EnableItineraryAutoRouteMutation, EnableItineraryAutoRouteMutationVariables>>) {
 ...
 *
 * To run a query within a Vue component, call `useGetItineraryDirectionsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetItineraryDirectionsQuery` returns an object from Apollo Client that contains result, loading and error properties
 * you can use to render your UI.
 *
 * @param variables that will be passed into the query
 * @param options that will be passed into the query, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/query.html#options;
 *
 * @example
 * const { result, loading, error } = useGetItineraryDirectionsQuery({
 *   id: // value for 'id'
 *   includeRoutePolyline: // value for 'includeRoutePolyline'
 * });
 */
export function useGetItineraryDirectionsQuery(variables: GetItineraryDirectionsQueryVariables | VueCompositionApi.Ref<GetItineraryDirectionsQueryVariables> | ReactiveFunction<GetItineraryDirectionsQueryVariables>, options: VueApolloComposable.UseQueryOptions<GetItineraryDirectionsQuery, GetItineraryDirectionsQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<GetItineraryDirectionsQuery, GetItineraryDirectionsQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<GetItineraryDirectionsQuery, GetItineraryDirectionsQueryVariables>> = {}) {
 ...
 *
 * To run a query within a Vue component, call `useGetItineraryQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetItineraryQuery` returns an object from Apollo Client that contains result, loading and error properties
 * you can use to render your UI.
 *
 * @param variables that will be passed into the query
 * @param options that will be passed into the query, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/query.html#options;
 *
 * @example
 * const { result, loading, error } = useGetItineraryQuery({
 *   id: // value for 'id'
 * });
 */
export function useGetItineraryQuery(variables: GetItineraryQueryVariables | VueCompositionApi.Ref<GetItineraryQueryVariables> | ReactiveFunction<GetItineraryQueryVariables>, options: VueApolloComposable.UseQueryOptions<GetItineraryQuery, GetItineraryQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<GetItineraryQuery, GetItineraryQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<GetItineraryQuery, GetItineraryQueryVariables>> = {}) {
 ...
 *
 * To run a query within a Vue component, call `useListItineraryLocationsQuery` and pass it any options that fit your needs.
 * When your component renders, `useListItineraryLocationsQuery` returns an object from Apollo Client that contains result, loading and error properties
 * you can use to render your UI.
 *
 * @param variables that will be passed into the query
 * @param options that will be passed into the query, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/query.html#options;
 *
 * @example
 * const { result, loading, error } = useListItineraryLocationsQuery({
 *   id: // value for 'id'
 *   first: // value for 'first'
 *   after: // value for 'after'
 *   includeRoutePolyline: // value for 'includeRoutePolyline'
 * });
 */
export function useListItineraryLocationsQuery(variables: ListItineraryLocationsQueryVariables | VueCompositionApi.Ref<ListItineraryLocationsQueryVariables> | ReactiveFunction<ListItineraryLocationsQueryVariables>, options: VueApolloComposable.UseQueryOptions<ListItineraryLocationsQuery, ListItineraryLocationsQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<ListItineraryLocationsQuery, ListItineraryLocationsQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<ListItineraryLocationsQuery, ListItineraryLocationsQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<ListItineraryLocationsQuery, ListItineraryLocationsQueryVariables>(ListItineraryLocationsDocument, variables, options);
}
export type ListItineraryLocationsQueryCompositionFunctionResult = VueApolloComposable.UseQueryReturn<ListItineraryLocationsQuery, ListItineraryLocationsQueryVariables>;
 ...
 *
 * To run a mutation, you first call `useMoveItineraryLocationAfterMutation` within a Vue component and pass it any options that fit your needs.
 * When your component renders, `useMoveItineraryLocationAfterMutation` returns an object that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - Several other properties: https://v4.apollo.vuejs.org/api/use-mutation.html#return
 *
 * @param options that will be passed into the mutation, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/mutation.html#options;
 *
 * @example
 * const { mutate, loading, error, onDone } = useMoveItineraryLocationAfterMutation({
 *   variables: {
 *     id: // value for 'id'
 ...
 * });
 */
export function useMoveItineraryLocationAfterMutation(options: VueApolloComposable.UseMutationOptions<MoveItineraryLocationAfterMutation, MoveItineraryLocationAfterMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<MoveItineraryLocationAfterMutation, MoveItineraryLocationAfterMutationVariables>>) {
  return VueApolloComposable.useMutation<MoveItineraryLocationAfterMutation, MoveItineraryLocationAfterMutationVariables>(MoveItineraryLocationAfterDocument, options);
}
export type MoveItineraryLocationAfterMutationCompositionFunctionResult = VueApolloComposable.UseMutationReturn<MoveItineraryLocationAfterMutation, MoveItineraryLocationAfterMutationVariables>;
 ...
 *
 * To run a mutation, you first call `useMoveItineraryLocationToStartMutation` within a Vue component and pass it any options that fit your needs.
 * When your component renders, `useMoveItineraryLocationToStartMutation` returns an object that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - Several other properties: https://v4.apollo.vuejs.org/api/use-mutation.html#return
 *
 * @param options that will be passed into the mutation, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/mutation.html#options;
 *
 * @example
 * const { mutate, loading, error, onDone } = useMoveItineraryLocationToStartMutation({
 *   variables: {
 *     id: // value for 'id'
 *   },
 * });
 */
export function useMoveItineraryLocationToStartMutation(options: VueApolloComposable.UseMutationOptions<MoveItineraryLocationToStartMutation, MoveItineraryLocationToStartMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<MoveItineraryLocationToStartMutation, MoveItineraryLocationToStartMutationVariables>>) {
  return VueApolloComposable.useMutation<MoveItineraryLocationToStartMutation, MoveItineraryLocationToStartMutationVariables>(MoveItineraryLocationToStartDocument, options);
}
export type MoveItineraryLocationToStartMutationCompositionFunctionResult = VueApolloComposable.UseMutationReturn<MoveItineraryLocationToStartMutation, MoveItineraryLocationToStartMutationVariables>;
 ...
 *
 * To run a mutation, you first call `useUpdateItineraryLocationIsOptionalMutation` within a Vue component and pass it any options that fit your needs.
 * When your component renders, `useUpdateItineraryLocationIsOptionalMutation` returns an object that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - Several other properties: https://v4.apollo.vuejs.org/api/use-mutation.html#return
 *
 * @param options that will be passed into the mutation, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/mutation.html#options;
 *
 * @example
 * const { mutate, loading, error, onDone } = useUpdateItineraryLocationIsOptionalMutation({
 *   variables: {
 *     id: // value for 'id'
 ...
 * });
 */
export function useUpdateItineraryLocationIsOptionalMutation(options: VueApolloComposable.UseMutationOptions<UpdateItineraryLocationIsOptionalMutation, UpdateItineraryLocationIsOptionalMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<UpdateItineraryLocationIsOptionalMutation, UpdateItineraryLocationIsOptionalMutationVariables>>) {
  return VueApolloComposable.useMutation<UpdateItineraryLocationIsOptionalMutation, UpdateItineraryLocationIsOptionalMutationVariables>(UpdateItineraryLocationIsOptionalDocument, options);
}
export type UpdateItineraryLocationIsOptionalMutationCompositionFunctionResult = VueApolloComposable.UseMutationReturn<UpdateItineraryLocationIsOptionalMutation, UpdateItineraryLocationIsOptionalMutationVariables>;
 ...
 *
 * To run a mutation, you first call `useUpdateItineraryLocationMutation` within a Vue component and pass it any options that fit your needs.
 * When your component renders, `useUpdateItineraryLocationMutation` returns an object that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - Several other properties: https://v4.apollo.vuejs.org/api/use-mutation.html#return
 *
 * @param options that will be passed into the mutation, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/mutation.html#options;
 *
 * @example
 * const { mutate, loading, error, onDone } = useUpdateItineraryLocationMutation({
 *   variables: {
 *     id: // value for 'id'
 *     location: // value for 'location'
 *   },
 * });
 */
export function useUpdateItineraryLocationMutation(options: VueApolloComposable.UseMutationOptions<UpdateItineraryLocationMutation, UpdateItineraryLocationMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<UpdateItineraryLocationMutation, UpdateItineraryLocationMutationVariables>>) {
  return VueApolloComposable.useMutation<UpdateItineraryLocationMutation, UpdateItineraryLocationMutationVariables>(UpdateItineraryLocationDocument, options);
}
export type UpdateItineraryLocationMutationCompositionFunctionResult = VueApolloComposable.UseMutationReturn<UpdateItineraryLocationMutation, UpdateItineraryLocationMutationVariables>;
 ...
 *
 * To run a mutation, you first call `useUpdateItineraryMutation` within a Vue component and pass it any options that fit your needs.
 * When your component renders, `useUpdateItineraryMutation` returns an object that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - Several other properties: https://v4.apollo.vuejs.org/api/use-mutation.html#return
 *
 * @param options that will be passed into the mutation, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/mutation.html#options;
 *
 * @example
 * const { mutate, loading, error, onDone } = useUpdateItineraryMutation({
 *   variables: {
 *     id: // value for 'id'
 *     itinerary: // value for 'itinerary'
 *   },
 * });
 */
export function useUpdateItineraryMutation(options: VueApolloComposable.UseMutationOptions<UpdateItineraryMutation, UpdateItineraryMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<UpdateItineraryMutation, UpdateItineraryMutationVariables>>) {
