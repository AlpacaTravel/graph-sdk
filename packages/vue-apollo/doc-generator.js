...
for use with Apollo and Vue.

- See [Installation and Getting Started](https://alpacatravel.github.io/graph-sdk/packages/vue-apollo/)
  `;
  const footer = ``;
...
function info(input) {
  ...
  const link = `https://alpacatravel.github.io/graph-sdk/packages/vue-apollo/docs/modules.html#${title}`;
